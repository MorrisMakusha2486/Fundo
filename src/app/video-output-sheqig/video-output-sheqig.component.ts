...
@Component({
  selector: 'app-video-output-sheqig',
  standalone: true,
  imports: [CommonModule, RouterModule,PlayerComponent],
  templateUrl: './video-output-sheqig.component.html',
  styleUrl: './video-output-sheqig.component.scss'
})
export class VideoOutputSheqigComponent implements OnInit {
